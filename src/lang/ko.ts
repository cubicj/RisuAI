export const languageKorean = {
    ...
    "help": {
        ...
        "hypaV3MaxMemoryTokensRatio": "현재 설정(프롬프트 템플릿, 캐릭터, 페르소나, 로어북 예산, HypaV3가 요약하지 않는 최근 채팅)으로 고정되는 프롬프트 오버헤드를 기준으로 추정한 메모리 토큰 비율의 최댓값입니다. 트리거와 턴마다 달라지는 로어북 활성화는 포함되지 않습니다.",
